...
try
{
    ...
    String sql = "select id,subject, content, writer from notice" + 
            " order by id desc";
    ...
    noticeList = "'notice_list':[" + tempList.toString() + "]";
}
catch(Exception ex)
{
