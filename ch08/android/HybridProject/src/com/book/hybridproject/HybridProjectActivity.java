...
import com.book.hybridproject.UtilCamera;
import com.book.hybridproject.UtilMoviePlayer;
import com.book.hybridproject.ProgressBar;

public class HybridProjectActivity extends Activity {
    ...
    private class NativeBridge{
    	...
    	public void callCamera() {    		    		
    		...
    		{      		
    			...
    			mHandler.post(new Runnable() {
    		    	public void run() {
    		    		Intent intent = new Intent(mContext, UtilCamera.class);
        ...
        //  동영상 Player.
    	public void callFileUpload( final String httpaddr, final String filename ) {
    		Log.i("callMoviePlayer", "START");
    		if(bCmdProcess)	
    			return;  
    		...
    		try
    		{
    			...
    			mHandler.post(new Runnable() {
    		    	public void run() {
    		    		...
    		    		{
    		    			Log.i("i", exLoc.toString());
    		    			String    strReturn = "alert('파일 Upload오류 오류!!')";
        	    	    	mWebView.loadUrl("javascript:" + strReturn);       		    		
    		    		}
    		    	}
    			});
			...
			throws ClientProtocolException
		{
			...
			try {
				...
				Log.e("FormReviewer", "Upload failed: " + cex.getMessage() + " Stacktrace: " + cex.getStackTrace());
				success = false;
			}catch (Exception ex) {
				Log.e("FormReviewer", "Upload failed: " + ex.getMessage() + " Stacktrace: " + ex.getStackTrace());
				success = false;
			} finally {
				Log.e("Error","h_f");
			}	
